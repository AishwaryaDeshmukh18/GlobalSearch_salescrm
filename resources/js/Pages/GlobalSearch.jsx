...
const contacts = useMemo(() => filterItems(dataset.contacts), [
  query,
  selectedBU,
  basicOwner,
  basicLifecycle,
...
const companies = useMemo(() => filterItems(dataset.companies), [contacts]);

const opportunities = useMemo(() => filterItems(dataset.opportunities), [contacts]);
...
{["Retail","Alliance","Enterprise"].map((bu)=>(
<button
key={bu}
...
<select value={basicOwner} onChange={(e)=>setBasicOwner(e.target.value)}>
...
<select value={basicLifecycle} onChange={(e)=>setBasicLifecycle(e.target.value)}>
...
<select value={basicStage} onChange={(e)=>setBasicStage(e.target.value)}>
...
<button className="reset-basic-btn" onClick={resetBasicFilters}>
Reset
</button>
...
<button className="close-btn" onClick={()=>setShowAdvanced(false)}>
×
</button>
...
<div className="adv-section-title">General</div>
...
<div className="adv-section-title">Lead</div>
...
<div className="adv-section-title">Opportunity</div>

<Select label="Stage" value={advStage} setValue={setAdvStage} options={stages}/>
...
<div className="adv-section-title">Activity</div>
